...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => adepanjiDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Ade Panji (6SIA5)'),
        ),
        body: LoginPage(),
      ),
    );
...
class adepanjiDataTable extends StatefulWidget {
  _adepanjiDataTableState createState() => _adepanjiDataTableState();
}

class _adepanjiDataTableState extends State<adepanjiDataTable> {
